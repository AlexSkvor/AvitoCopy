...
//TODO don't forget to check every line for mapping in loaders!!!!
@Entity
@Table(name = "CARS")
data class CarEntity(
        @Id
        @Column(name = "originalUrl", nullable = false, unique = true, length = 511)
        ...
        @Column(name = "imageUrl", nullable = false, length = 511)
        val imageUrl: String = "",
        ...
        @Column(name = "powerSteering", nullable = false, length = 2000)
        val powerSteering: String = "",

        @Column(name = "climateControl", nullable = false, length = 2000)
        val climateControl: String = "",

        @Column(name = "salon", nullable = false, length = 2000)
        val salon: String = "",

        @Column(name = "heating", nullable = false, length = 2000)
        val heating: String = "",

        @Column(name = "windowsPower", nullable = false, length = 2000)
        val windowsPower: String = "",

        @Column(name = "electricDrive", nullable = false, length = 2000)
        val electricDrive: String = "",

        @Column(name = "settingsMemory", nullable = false, length = 2000)
        val settingsMemory: String = "",

        @Column(name = "drivingAssistance", nullable = false, length = 2000)
        val drivingAssistance: String = "",

        @Column(name = "antitheftSystem", nullable = false, length = 2000)
        val antitheftSystem: String = "",

        @Column(name = "airBag", nullable = false, length = 2000)
        val airBag: String = "",

        @Column(name = "activeSafety", nullable = false, length = 2000)
        val activeSafety: String = "",

        @Column(name = "multimediaAndNavigation", nullable = false, length = 2000)
        val multimediaAndNavigation: String = "",

        @Column(name = "audioSystem", nullable = false, length = 2000)
        val audioSystem: String = "",

        @Column(name = "tiresAndWheels", nullable = false, length = 2000)
        val tiresAndWheels: String = "",

        @Column(name = "informationAboutTO", nullable = false, length = 2000)
        val informationAboutTO: String = "",

        @Column(name = "headlights", nullable = false, length = 2000)
