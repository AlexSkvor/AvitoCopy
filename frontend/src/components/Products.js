        ...
        <div className="card-style" >
            <div className="my-2 mx-auto p-relative bg-white shadow-1 blue-hover" >
                ...
                <div className="px-2 py-2">
                    <p className="mb-0 small font-weight-medium text-uppercase mb-1 text-muted lts-2px"> Товар </p>
                ...
                <a href="#0" className="text-uppercase  d-inline-block font-weight-medium lts-2px ml-2 mb-2 text-center styled-link">{props.contact}</a>
            </div>
        </div>
    )
}
